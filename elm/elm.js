...
var _user$project$Main$inputEditClass = function (editPlayerId) {
...
var _user$project$Main$insertEditClass = F2(
	function (editPlayerId, player) {
		var mPlayerId = function () {
		...
		return _elm_lang$core$Native_Utils.eq(player.id, mPlayerId) ? 'editing' : 'not-editing';
	});
...
var _user$project$Main$checkPlayerPoints = F3(
	function (id, points, player) {
...
var _user$project$Main$subtractPoints = F2(
	function (play, players) {
		return _elm_lang$core$Native_Utils.eq(players.id, play.playerId) ? _elm_lang$core$Native_Utils.update(
			players,
			{points: players.points - (1 * play.points)}) : players;
	});
var _user$project$Main$filterPlay = F2(
	function (id, play) {
		return !_elm_lang$core$Native_Utils.eq(play.id, id);
	});
var _user$project$Main$removePlay = F2(
	function (play, model) {
		var newPlayers = A2(
			_elm_lang$core$List$map,
			_user$project$Main$subtractPoints(play),
			model.players);
		var newPlays = A2(
			_elm_lang$core$List$filter,
			_user$project$Main$filterPlay(play.id),
			model.plays);
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Main$score = F3(
	function (model, scorer, points) {
		...
		var newPlayers = A2(
			_elm_lang$core$List$map,
			A2(_user$project$Main$checkPlayerPoints, scorer.id, points),
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			default:
				return A2(_user$project$Main$removePlay, _p3._0, model);
		}
	});
...
var _user$project$Main$playList = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('play-list'),
			_1: {ctor: '[]'}
		},
...
var _user$project$Main$playSection = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('play-section'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$class(
							_user$project$Main$inputEditClass(model.playerId)),
						_1: {
							ctor: '::',
...
var _user$project$Main$players = F2(
	function (editPlayerId, player) {
		return A2(
			_elm_lang$html$Html$li,
			{ctor: '[]'},
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								A2(_user$project$Main$insertEditClass, editPlayerId, player)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$playerList = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('player-list'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$players(model.playerId),
			A2(
...
var _user$project$Main$playerSection = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('player-section'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
